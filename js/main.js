...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _header_main_menu_main_menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./header/main-menu/main-menu */ "./src/components/header/main-menu/main-menu.js");
/* harmony import */ var _header_main_menu_main_menu__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_header_main_menu_main_menu__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _header_search_search__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./header/search/search */ "./src/components/header/search/search.js");
/* harmony import */ var _header_search_search__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_header_search_search__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _content_content__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_content_content__WEBPACK_IMPORTED_MODULE_2__);
// Form
...
/***/ "./src/components/header/main-menu/main-menu.js":
/*!******************************************************!*\
  !*** ./src/components/header/main-menu/main-menu.js ***!
  \******************************************************/
/***/ (() => {

var MAIN_MENU = document.querySelector('#mainMenu');
var DROPDOWN_MENUS = document.querySelectorAll('.main-menu__dropdown');
var MAIN_MENU_LINKS = document.querySelectorAll('.main-menu__link');
var MAIN_MENU_BTN = document.querySelector('#mainMenuBtn');
DROPDOWN_MENUS.forEach(function (menu) {
  menu.addEventListener('mouseover', function () {
    MAIN_MENU_LINKS.forEach(function (link) {
      link.classList.add('main-menu__link--focused');
    });
  });
});
DROPDOWN_MENUS.forEach(function (menu) {
  menu.addEventListener('mouseleave', function () {
    MAIN_MENU_LINKS.forEach(function (link) {
      link.classList.remove('main-menu__link--focused');
    });
  });
});
...
/***/ "./src/components/header/search/search.js":
/*!************************************************!*\
  !*** ./src/components/header/search/search.js ***!
  \************************************************/
/***/ (() => {

var HEADER_SEARCH_FORM = document.querySelector('#headerSearchForm'),
    HEADER_SEARCH_BTN = document.querySelector('#headerSearchBtn'),
    HEADER_SEARCH_BOX = document.querySelector('.header__search-box'),
    HEADER_SEARCH_FIELD = document.querySelector('.header__search-box input');
var clickState = false,
    inputState = false;

var hideSearchBox = function hideSearchBox() {
  if (HEADER_SEARCH_FIELD !== document.activeElement && !HEADER_SEARCH_BOX.matches(':hover')) {
    HEADER_SEARCH_BTN.classList.remove('btn--focused');
    HEADER_SEARCH_BOX.classList.remove('header__search-box--focused');
    HEADER_SEARCH_BOX.classList.remove('is-invalid');
  }
};

var showSearchBox = function showSearchBox() {
  HEADER_SEARCH_BTN.classList.add('btn--focused');
  HEADER_SEARCH_BOX.classList.add('header__search-box--focused');
};

var searchFieldValidate = function searchFieldValidate() {
  return HEADER_SEARCH_FIELD.value.length < 3 ? false : true;
};
...
var handleSearchBtnClick = function handleSearchBtnClick() {
  if (clickState === false) {
    ...
    if (!HEADER_SEARCH_BOX.classList.contains('header__search-box--focused')) {
      showSearchBox();
    }
  } else {
    clickState = false;

    if (inputState === true || searchFieldValidate() && HEADER_SEARCH_BOX.classList.contains('header__search-box--focused')) {
      if (searchFieldValidate()) {
        HEADER_SEARCH_FORM.submit();
      } else {
        HEADER_SEARCH_BOX.classList.add('is-invalid');
      }
    }
  }
};

HEADER_SEARCH_BTN.addEventListener('mouseover', function () {
  setTimeout(showSearchBox, 100);
});
HEADER_SEARCH_BTN.addEventListener('mouseleave', function () {
  setTimeout(hideSearchBox, 100);
});
HEADER_SEARCH_BTN.addEventListener('mouseup', function () {
  handleSearchBtnClick();
});
HEADER_SEARCH_BOX.addEventListener('mouseleave', function () {
  hideSearchBox();
});
HEADER_SEARCH_FIELD.addEventListener('focusin', function () {
  inputState = true;
});
HEADER_SEARCH_FIELD.addEventListener('focusout', function () {
  hideSearchBox();

  if (!HEADER_SEARCH_BOX.matches(':hover') && !HEADER_SEARCH_BTN.matches(':hover')) {
    inputState = false;
  }
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _inits_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./inits/modal */ "./src/vendor/bootstrap/inits/modal.js");
/* harmony import */ var _inits_carousel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./inits/carousel */ "./src/vendor/bootstrap/inits/carousel.js");



/***/ }),

/***/ "./src/vendor/bootstrap/inits/carousel.js":
/*!************************************************!*\
  !*** ./src/vendor/bootstrap/inits/carousel.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var mainCarouselInstance = new (bootstrap_js_dist_carousel__WEBPACK_IMPORTED_MODULE_0___default())(mainCarousel, {
  interval: 5000,
  wrap: true
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (mainCarouselInstance);

/***/ }),

/***/ "./src/vendor/bootstrap/inits/modal.js":
/*!*********************************************!*\
  !*** ./src/vendor/bootstrap/inits/modal.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var $modals = Array.from(document.querySelectorAll('[data-bs-toggle="modal"]'));
var modals = $modals.map(function ($modal) {
  return new (bootstrap_js_dist_modal__WEBPACK_IMPORTED_MODULE_0___default())($modal);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _bootstrap_bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bootstrap/bootstrap */ "./src/vendor/bootstrap/bootstrap.js");
...
new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('#applicationSlide', {
  type: 'slide',
  pagination: false,
  isNavigation: true,
  arrows: false,
